            ...
            <v-col cols="10" class="table">
                <template v-if="!showDialog">
                    ...
                    <v-row class="wrap-buttons">
                        ...
                        <v-col cols="3">
                            <v-btn color="grey" class="ma-2 white--text" @click="showDialog = true; isRegister = true;">
                                Cadastrar Aluno
                            </v-btn>
                        </v-col>
                    </v-row>
                ...
                <template v-if="showDialog">
                    <v-row justify="center" class="pa-1 header">
                        <template v-if="isRegister">Cadastro de aluno</template>
                        <template v-if="!isRegister">Editar de aluno</template>
                        
                        <!-- <span v-if="isRegister">Cadastro de aluno</span>
                        <span v-if="!isRegister">Editar aluno</span> -->
                    </v-row>
                    <register-edit-student @dialog="receiveValueWatch" />
                </template>
            </v-col>
        </v-row>
    </v-container>
