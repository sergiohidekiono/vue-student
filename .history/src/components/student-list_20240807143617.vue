...
export default {
    ...
    methods: {
        ...
        fetchStudentById(){
            this.fetchStudents();
            console.log('DIGITADO: ',this.formData.name.toLowerCase())
            let filterStudent = this.students.includes(student => student.name.toLowerCase() === this.formData.name.toLowerCase());
