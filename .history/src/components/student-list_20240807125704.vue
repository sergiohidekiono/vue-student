        ...
        <v-row>
            ...
            <v-col cols="10" class="table">
                ...
                <v-row class="wrap-buttons">
                    ...
                    <v-col cols="3">
                        <v-btn color="grey" class="ma-2 white--text" @click="openDialog"> Cadastrar Aluno </v-btn>
                        <!-- <register-edit-student-modal v-if="showDialog" :dialog="showDialog" @close="handleCloseDialog" /> -->
                        <register-edit-student v-if="showDialog" :dialog="showDialog" @close="handleCloseDialog" />
                    </v-col>
                </v-row>
...
// import RegisterEditStudentModal from './register-edit-student-modal.vue';
...
export default {
    ...
    methods: {
        ...
        handleCloseDialog() {
            console.log('entrei no handleclose')
