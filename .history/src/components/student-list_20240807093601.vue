        ...
        <v-row>
            <v-col cols="2">
                <v-navigation-drawer v-model="drawer" app clipped :permanent="false">
                    <v-list>
                        <v-list-item>
                            <v-list-item-content class="header-table">
...
export default {
    mounted() {
        this.$nextTick(() => {
            const elements = document.querySelectorAll('.v-list-item-content');
...
.header-table {
    ...
    background: #999999;
    padding: 0 !important;
    /* Força a remoção do padding */
}

.v-list-item-content {
    padding: 0 !important;
    /* Remove padding dos itens de lista */
}

.v-list-item-title {
    padding: 0 !important;
    /* Remove padding dos títulos */
}
</style>